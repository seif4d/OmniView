...
<p align="center">
  <img src="https://raw.githubusercontent.com/seif4d/OmniView/main/OmniView.png" alt="OmniView Screenshot" width="85%">
</p>
...
6. [🤝 المساهمة | Contributing](#-المساهمة--contributing)
7. [⭐ أظهر دعمك | Show Your Support](#️-أظهر-دعمك--show-your-support)
8. [📜 الترخيص | License](#-الترخيص--license)
...
### الطريقة الثانية: تحويل ملف `chat.html` لـ  `json`

إذا كان ملف التصدير الخاص بك يحتوي على `chat.html` بدلاً من `conversations.json` بدلاً من ، اتبع هذه الخطوات السحرية لتحويله:
...
## ⭐ أظهر دعمك | Show Your Support

إذا وجدت هذا المشروع مفيداً وممتعاً، لا تتردد في منحه **نجمة ⭐** على GitHub! هذا يساعد المشروع على النمو والوصول إلى المزيد من الأشخاص.
